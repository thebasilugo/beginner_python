...
if user_name != 'thebasilugo':
    ...
    # Should maybe have a "End" to end process, instead of forcing customers to buy.

elif user_name == 'thebasilugo':
    print("Welcome chief, I hope you're having a lovely day.")
    #should automatically log 'thebasilugo' in as a staff (or eexecutive, if dashboard should exist)
